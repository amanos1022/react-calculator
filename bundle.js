...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Calculator = __webpack_require__(160);

	var _Calculator2 = _interopRequireDefault(_Calculator);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	_reactDom2.default.render(_react2.default.createElement(_Calculator2.default, { title: 'Simple Calculator', className: 'calculator' }), document.getElementById('container'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _OperatorButton = __webpack_require__(161);

	var _OperatorButton2 = _interopRequireDefault(_OperatorButton);

	var _CalculatorNumberButton = __webpack_require__(162);

	var _CalculatorNumberButton2 = _interopRequireDefault(_CalculatorNumberButton);
	...
	var Calculator = function (_React$Component) {
		...
		function Calculator(props) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(Calculator).call(this, props));

			_this2.state = { display: 0 };

			_this2.equationStack = [];
			_this2.postOperation = false;
			_this2.nextOperation = null;
			_this2.postEquals = true; //after equals button pressed
			_this2.init = true;
			return _this2;
		}
		...
		_createClass(Calculator, [{
			key: 'buttonClick',
			value: function buttonClick(e, num) {
				this.init = false;
			...
			key: 'addEquation',
			value: function addEquation(value, operation) {
			...
			key: 'operatorClick',
			value: function operatorClick(display, operation) {
				if (!this.init) {
					if (this.postEquals != true && this.postOperation != true) {
			...
			value: function render() {
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						'div',
						{ className: 'numbers' },
						_react2.default.createElement('input', { type: 'text', value: this.state.display, readOnly: true }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 1 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 2 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 3 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 4 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 5 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 6 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 7 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 8 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 9 }),
						_react2.default.createElement(_CalculatorNumberButton2.default, { onClickButton: this.buttonClick.bind(this), label: 'label', value: 0 })
					),
					_react2.default.createElement(
						'div',
						{ className: 'operators' },
						_react2.default.createElement(_OperatorButton2.default, { addEquation: this.operatorClick.bind(this), display: this.state.display, operation: '+' }),
						_react2.default.createElement(_OperatorButton2.default, { addEquation: this.operatorClick.bind(this), display: this.state.display, operation: '-' }),
						_react2.default.createElement(_OperatorButton2.default, { addEquation: this.operatorClick.bind(this), display: this.state.display, operation: '*' }),
						_react2.default.createElement(_OperatorButton2.default, { addEquation: this.operatorClick.bind(this), display: this.state.display, operation: '/' }),
						_react2.default.createElement(
							'button',
							{ onClick: this.equate.bind(this) },
							'='
						),
						_react2.default.createElement(
							'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var OperatorButton = function (_React$Component) {
		_inherits(OperatorButton, _React$Component);

		function OperatorButton() {
			_classCallCheck(this, OperatorButton);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(OperatorButton).apply(this, arguments));
		}
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					{ onClick: function onClick(e) {
							return _this2.props.addEquation(_this2.props.display, _this2.props.operation);
						} },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CalculatorNumberButton = function (_React$Component) {
		_inherits(CalculatorNumberButton, _React$Component);

		function CalculatorNumberButton(props) {
			_classCallCheck(this, CalculatorNumberButton);

			return _possibleConstructorReturn(this, Object.getPrototypeOf(CalculatorNumberButton).call(this, props));
		}

		_createClass(CalculatorNumberButton, [{
			key: 'render',
			value: function render() {
				var _this2 = this;
				...
				return _react2.default.createElement(
					'button',
					{ onClick: function onClick(e) {
							return _this2.props.onClickButton(e, _this2.props.value);
						} },
					this.props.value
				);
			}
	...
	exports.default = CalculatorNumberButton;
